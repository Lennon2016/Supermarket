...
<div class="header">
  <div class="w900 mt30 cut">
    <div class="logo"><a href="../index.php"><img src="../images/logo2.jpg" height="75px" width="375px"></a></div>
  </div>
</div>
<!-- 头部结束 -->
<!-- 主体开始 -->
  ...
  <div class="wbox cut">
    ...
    <form method="post" action="dologin.php" id="login-form">
      ...
      <div class="login ml530">
        ...
        <div class="c999 mt20">您还没有账号？ 立即<a class="ml5" href="regist.php">免费注册</a></div>
